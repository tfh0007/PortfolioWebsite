...
function bannerLoop4() {
    ...
    if(bannerStatus4 === 1) {
        ...
        setTimeout(function() {
                ...
                document.getElementById("imgban11").style.right = "-673.2px"
                document.getElementById("imgban11").style.zIndex = "1500"

                document.getElementById("imgban12").style.right = "673.2px"
    ...
    // We need three === here otherwise nothing happens
        ...
        setTimeout(function() {
                ...
                document.getElementById("imgban10").style.right = "673.2px"
